...
{ 
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine($"¡Hola {nombre}! por favor, elige un ejercicio del siguiente menu:");
            Menu.MostrarMenu();
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Entrada no valida. Por favor, ingrese un numero del 1 al 15, o 'exit' o 'q' para salir.");
                }
            }
